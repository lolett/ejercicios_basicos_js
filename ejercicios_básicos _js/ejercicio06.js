...
console.log('Aquí comienza el output del ejercicio 1.1')
...
console.log('Aquí comienza el output del ejercicio 1.2')
...
console.log('Aquí comienza el output del ejercicio 1.3')
